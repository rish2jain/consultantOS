...
@router.post("/porter")
async def porter_figure(data: core_models.PortersFiveForces, report_id: str | None = None):
...
@router.post("/swot")
async def swot_matrix(data: core_models.SWOTAnalysis, report_id: str | None = None):
...
async def porter_from_report(report: core_models.StrategicReport, report_id: str | None = None):
...
async def swot_from_report(report: core_models.StrategicReport, report_id: str | None = None):
